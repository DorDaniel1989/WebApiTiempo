...
namespace WebApi.Middleware
{
    public class JwtMiddleware
    {
        ...
        public async Task Invoke(HttpContext context, WebApiTiempoContext userService)
        {
            // ====> Request ===>
        ...
        private void attachUserToContext(HttpContext context, WebApiTiempoContext userService, string token)
        {
            try
            {
